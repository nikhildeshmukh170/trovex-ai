        ...
        <div className="flex flex-col gap-10 w-full lg:w-auto top-10">
          ...
          <div 
            ...
            className={`bg-purple-50 rounded-4xl p-10 w-full max-w-xl border border-gray-300 transition-all duration-700 ease-in-out ${
              createScenarioInView ? "opacity-100 transform translate-y-0" : "opacity-0 transform translate-y-10"
            } sticky top-0`}
          >
            <div className="flex flex-col gap-5 justify-center bg-white p-8 rounded-3xl">
              ...
              <div className="bg-purple-100 p-6 rounded-3xl">
                <div className="flex items-center gap-2 mb-1.5">
                  ...
                  <span className="bg-gradient-to-b from-purple-600 to-pink-500 bg-clip-text text-transparent font-bold">Topic</span>
                </div>
              ...
              <div className="bg-purple-100 p-6 rounded-3xl">
                <div className="flex items-center gap-2 mb-1.5">
                  ...
                  <span className="bg-gradient-to-b from-purple-600 to-pink-500 bg-clip-text text-transparent font-bold">Persona</span>
                </div>
                <div className="w-full rounded-xl border border-purple-100 flex justify-between items-center p-2">
            ...
            <div>
              ...
              <p className="text-gray-900">
                Craft hyper-realistic scenarios that mirror your most challenging
          ...
          <div
            ref={powerUpRef}
            className={`bg-purple-50 rounded-4xl p-10 w-full max-w-xl border border-gray-300 transition-all duration-700 ease-in-out ${
              powerUpInView ? "opacity-100 transform translate-y-0" : "opacity-0 transform translate-y-10"
            } sticky top-0`}
            style={{ top: "100px" }}
          >
            <div className="flex flex-col gap-5 justify-center bg-white p-8 rounded-3xl">
          ...
          <div
            ref={reviewRef}
            className={`bg-purple-50 rounded-4xl p-10 w-full max-w-xl border border-gray-300 transition-all duration-700 ease-in-out ${
              reviewInView ? "opacity-100 transform translate-y-0" : "opacity-0 transform translate-y-10"
            } sticky top-0`}
            style={{ top: "200px" }}
          >
            <div className="flex flex-col gap-5 justify-center bg-white p-8 rounded-3xl">
