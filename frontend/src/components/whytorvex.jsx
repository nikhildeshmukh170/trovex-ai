...
const Whytorvex = () => {
  return (
    <div className="flex flex-col gap-8 relative m-4 px-12 py-7 h-auto w-auto bg-[#2f1043] rounded-3xl font-sans">
      ...
      <div className="flex flex-col justify-center items-center gap-15 py-30 z-11">
        ...
        <div className='flex flex-col gap-10 w-[1000px] text-white text-4xl px-4 font-normal font-sans'>
